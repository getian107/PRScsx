...
**PRS-CS-mult** is a Python based command line tool for multi-ethnic multi-trait polygenic prediction, which infers posterior SNP effect sizes under continuous shrinkage (CS) priors using GWAS summary statistics and external LD reference panels. It is an extension of the polygenic prediction method PRS-CS (`https://github.com/getian107/PRScs`), described in the article:
...
- Clone this repository using the following git command:
    ...
    `git clone https://github.com/getian107/PRScs-mult.git`

    Alternatively, download the source files from the github website (`https://github.com/getian107/PRScs-mult`)
...
- PRScs-mult is currently written and tested with Python 2.X.

- PRScs-mult requires Python packages **scipy** (https://www.scipy.org/) and **h5py** (https://www.h5py.org/) installed.
 
- Once Python and its dependencies have been installed, running

    `./PRScs-mult.py --help` or `./PRScs.py -h`
